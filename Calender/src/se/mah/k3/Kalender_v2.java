...
public class Kalender_v2 extends JFrame {
	...
	public Kalender_v2() {
		...
		lblNewLabel
				.setIcon(new ImageIcon(Kalender_v2.class.getResource("/GUIBackground/Calenderscreen_clean_new.png")));
	...
	// Så här anropas GUI en gång var 5:e sekund och så skall allt uppdateras
	// kanse skall gå långsammare men för test.
